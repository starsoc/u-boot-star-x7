...
{
	gpio_set_output(STARSOC_RESET_PIN, 0);
}
...
//	printf(">> get gpio %d: %d\n", STARSOC_RESET_PIN, gpio_get_value(STARSOC_RESET_PIN));

	/* Reset Ethernet PHY and USB PHY here */
	gpio_set_value(STARSOC_RESET_PIN, 0);
	mdelay(50);
	gpio_set_value(STARSOC_RESET_PIN, 1);
	mdelay(50);
